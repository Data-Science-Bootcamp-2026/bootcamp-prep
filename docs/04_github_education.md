...
- The GitHub Copilot plan for [students](https://docs.github.com/en/copilot/how-tos/copilot-on-github/set-up-copilot/enable-copilot/set-up-for-students){target="_blank"} is Copilot Student, which sits somewhere between Copilot Free and Copilot Pro
